...
def process_all(images_pattern: str, model: str, output_dir: str) -> None:
    # Load the images
    ...
    # Create the output directory: output_dir/model/dirname
...
def main(model: str, images_pattern: str, output_dir: str, directories: tuple[str, ...]):
    try:
        for dir in directories:
            ...
            process_all(pattern, model, output_dir)
